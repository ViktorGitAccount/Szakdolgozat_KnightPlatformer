...
public class BattleStateBoss : EnemyState
{
    protected Enemy_BossLvl1 enemy;
    private Transform player;
    private int moveDir;
    private bool flippedOnce;
    public BattleStateBoss(Enemy _enemyBase, EnemyStateMachine _stateMachine, string _animatorBoolName, Enemy_BossLvl1 _enemy) : base(_enemyBase, _stateMachine, _animatorBoolName)
    {
        this.enemy = _enemy;
    }
